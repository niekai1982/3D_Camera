...
if __name__ == '__main__':
    ...
    # pattern_mode(input_type='flash', num_pats=3, fps=222,bit_depth=7,led_color=0b111)
    # power_up()
    pattern_mode(input_type='flash', num_pats=10, fps=0.5,bit_depth=1,led_color=0b111)
    # power_down()
